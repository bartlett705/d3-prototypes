...
function render() {
    ...
    var whee = setInterval(function () {
        return createTriange(svg, { l: Math.random() * 150 });
    }, 100);
}
var createTriange = function createTriange(svg, inputSpecs) {
    var specs = calculateTrianglePathEnds(inputSpecs);
    svg.selectAll('g').data(specs).enter().append('path').attr('d', function (specs) {
        return stroker(specs);
    }).attr('stroke', getRandomColor()).attr('stroke-width', 1).attr('fill', 'none').style('opacity', 0.8);
};
var stroker = __WEBPACK_IMPORTED_MODULE_0_d3__["line"]();
var getRandomColor = function getRandomColor() {
    return "#000000".replace(/0/g, function () {
        return (~~(Math.random() * 16)).toString(16);
    });
};
var calculateTrianglePathEnds = function calculateTrianglePathEnds(_ref) {
    var _ref$l = _ref.l,
        l = _ref$l === undefined ? 1 : _ref$l,
        _ref$x = _ref.x,
